...
import type { MetricSnapshot } from '@hardware-overlay/shared/metrics'
...
<template>
  <main class="overlay expanded trend-window">
    <header class="panel-header" @pointerdown="startDrag" @pointermove="moveDrag" @pointerup="stopDrag" @pointercancel="stopDrag">
      ...
      <button class="panel-close" type="button" aria-label="关闭趋势分析" @pointerdown.stop @click.stop="closeTrend">×</button>
    </header>
